...
import { Button, Input, Image, ColorPicker, Divider, Slider, Upload, Select, Option, Form, FormItem, Tooltip, Popover, Dialog, Dropdown, DropdownMenu, DropdownItem, Progress, Message } from 'element-ui'
// bus
